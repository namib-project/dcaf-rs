...
use crate::token::cose::encrypt::encrypt0::CoseEncrypt0BuilderExt;
...
use coset::{
    CborSerializable, CoseEncrypt, CoseEncrypt0, CoseEncryptBuilder, CoseError, CoseKey,
    CoseKeyBuilder, CoseRecipientBuilder, EncryptionContext, Header, HeaderBuilder,
